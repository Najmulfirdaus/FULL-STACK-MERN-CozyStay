...
function ListingPage3() {
    ...
    let {
        ...
        backEndImage1, backEndImage2, backEndImage3, // ये असल Files होनी चाहिए
    ...
    const submitHandler = () => {
        ...
        // Files को Append करें (ध्यान दें: backEndImage में File Object होना चाहिए)
        if (backEndImage1) formData.append('image1', backEndImage1);
        if (backEndImage2) formData.append('image2', backEndImage2);
        if (backEndImage3) formData.append('image3', backEndImage3);

        // Context वाले फंक्शन को यह formData भेजें
    ...
    return (
        <div className='w-[100%] h-[100vh] bg-[white] flex items-center justify-center gap-[10px] flex-col overflow-auto relative'>
            ...
            <div className='w-[95%] h-[400px] flex items-center justify-center flex-col md:w-[80%] md:flex-row '>
                ...
                <div className='w-[100%] h-[50%] flex items-center justify-center md:w-[50%] md:h-[100%] md:flex-col '>
                    <div className='w-[100%] h-[100%] overflow-hidden flex items-center justify-center border-[2px] '>
                        <img src={frontEndImage2} alt="" className='w-[100%] object-cover' />
                    </div>
                    <div className='w-[100%] h-[100%] overflow-hidden flex items-center justify-center border-[2px] '>
                        <img src={frontEndImage3} alt="" className='w-[100%] object-cover' />
                    </div>
                </div>
            </div>
